...
public class Goblin_fight_mal  extends BasicGameState {
        ...
        if (ClaseEstatica.getPersonaje().getVida() > 0 && ClaseEstatica.getEnemigo().getVida() > 0) {
                ...
                if (entrada.isKeyPressed(Input.KEY_RIGHT) && indicador >= 2) {
                    ...
                    if (indicador <= 4) {
                        ...
                        if (indicador == 2) {
                            ...
                            texto = GameStatus.hero.getAtaques().get(0).getDescripcion();
                        } else if (indicador == 3) {
                            puntero.setPosicion(a2);
                            texto = GameStatus.hero.getAtaques().get(1).getDescripcion();
                        } else if (indicador == 4) {
                            puntero.setPosicion(a3);
                            texto = GameStatus.hero.getAtaques().get(2).getDescripcion();
                        }
                    }
            ...
            if (entrada.isKeyPressed(Input.KEY_ENTER)) {
                ...
                if (indicador == 0) {
                    ...
                    if ((turno) && (dato > tEspera)) {
                        textoAccion = ClaseEstatica.getPersonaje().atacar(Goblin, 0);
                        turno = false;
                        dato = 0;
                        ataque = ClaseEstatica.getUltimoAtaque();
                    }
                    ...
                    if ((turno) && (dato > tEspera)) {
                        textoAccion = ClaseEstatica.getPersonaje().atacar(Goblin, 1);
                        turno = false;
                        dato = 0;
                        ataque = ClaseEstatica.getUltimoAtaque();
                    }
                    ...
                    if ((turno) && (dato > tEspera)) {
                        textoAccion = ClaseEstatica.getPersonaje().atacar(Goblin, 2);
                        turno = false;
                        dato = 0;
                        ataque = ClaseEstatica.getUltimoAtaque();
                    }
