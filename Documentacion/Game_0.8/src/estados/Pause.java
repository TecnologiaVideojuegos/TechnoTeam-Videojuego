...
/**
 * Presiona ESC para entrar en el menu de pausa
 * Te permite reanudar la partida, volver al menu y salir del juego
 * 
 */
...
public class Pause extends BasicGameState {
    ...
    //Cambia la interfaz que se ve dependiendo de la opci�n elegida
    @Override
