...
//    private Image HUD;
    ...
    //Nombre y estadísticas del protagonista
    @Override
    public void update(GameContainer gc, StateBasedGame sbg, int i) throws SlickException {
        ...
        if ((xpos > 664 && xpos < 813) && (ypos > 220 && ypos < 263)) {
            ...
            if (input.isMousePressed(0) && !avatarName.equalsIgnoreCase("")) {
                ...
                if(actualImage==0){
                    ataque1 = new Ataque(35, 30, "Tajo", "Cortas al enemigo con tu espada", 10);
                    ataque2 = new Ataque(55, 10, "Estocada", "Cargas contra el enemigo con tu espada", 20);
                    ataque3 = new Ataque(75, 5, "Bola de fuego", "Quemas al enemigo con tu magia", 40);
