...
public class Estado_2_OPCIONES extends BasicGameState {
    ...
    public void render(GameContainer container, StateBasedGame sbg, Graphics g) throws SlickException {
        ...
        Fuente.print25().drawString(565, 260, "OpciÃ³n 1", ctab[0]);
        Fuente.print25().drawString(565, 345, "OpciÃ³n 2", ctab[1]);
        Fuente.print25().drawString(565, 430, "OpciÃ³n 3", ctab[2]);
